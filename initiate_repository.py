#!/usr/bin/env python3
"""Create the local data directories required by the pipelines.
...
def initialize_repository(
    ...
    """Create required data directories beneath a repository root.

    Args:
        repository_root: Repository directory that will contain ``data``.

    Returns:
        Absolute paths to all required data directories.
    """
...
def main() -> None:
    ...
    print("Repository data directories are ready:")
    for directory_path in created_paths:
